    ...
    return (
        <div className="rounded-xl overflow-hidden border border-gray-200 mt-5">
            ...
            <div className="bg-white p-4">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full border border-green-500 rounded-lg py-2.5 text-green-600 font-semibold text-sm hover:bg-green-50 transition-colors">
